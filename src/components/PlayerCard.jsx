    ...
    >
      ...
      <div style={{ width: '100%', height: '64px', overflow: 'hidden', position: 'relative', background: 'linear-gradient(180deg, #c8d8f0 0%, #e8f0fa 100%)' }}>
        <img
          ...
          src={player.photo || 'https://gqslryreaiqmvnyyhwzf.supabase.co/storage/v1/object/public/photoplayers/fallback-dark.png'}
          alt={player.name}
          style={{
            width: '100%',
            height: '100%',
          ...
          onError={e => {
            e.target.src = 'https://gqslryreaiqmvnyyhwzf.supabase.co/storage/v1/object/public/photoplayers/fallback-dark.png'
          }}
        />
