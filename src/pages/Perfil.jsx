        ...
        <div style={{ background: 'white', borderRadius: '16px', padding: '32px', boxShadow: '0 2px 8px rgba(0,0,0,0.08)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '32px' }}>
            <div
              ...
              style={{ width: '100px', height: '100px', borderRadius: '50%', border: '3px solid #f5c400', overflow: 'hidden', background: '#f5c400', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', position: 'relative' }}
            >
              {avatarPreview ? (
          ...
          {guardado ? (
            ...
            <button
              ...
              disabled={guardando}
              style={{ width: '100%', padding: '14px', borderRadius: '8px', border: 'none', background: '#0B4390', color: 'white', fontSize: '15px', fontFamily: 'sans-serif', fontWeight: 'bold', cursor: guardando ? 'default' : 'pointer', opacity: guardando ? 0.7 : 1 }}
            >
